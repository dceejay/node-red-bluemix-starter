...
module.exports = function(RED) {
    ...
    var mhservices = appEnv.services.mqlight || [];
    var mlserviceList = services.map(function(s) { return s.name; });
    var mhserviceList = mhservices.map(function(s) { return s.name; });
    var serviceList = mlserviceList.concat(mhserviceList);
    console.log("BIG",serviceList);
    ...
    function MQLightIn2(n) {
        ...
        if (node.service === "") {
            ...
            if (serv.label === "messagehub") {
                opts = {
                    service: cred.mqlight_lookup_url,
                    user: cred.user,
    ...
    RED.nodes.registerType("mqlight2 in", MQLightIn2);

    function MQLightOut2(n) {
        RED.nodes.createNode(this, n);
        this.service = n.service || "";
        this.topic = n.topic || "";
        var node = this;
    ...
    RED.nodes.registerType("mqlight2 out", MQLightOut2);
}
